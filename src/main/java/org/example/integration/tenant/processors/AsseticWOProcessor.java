    ...
    public void run() {
        ...
        for (String id : items) {
            ...
            if (isAuthorityId(wo.getExternalId())) {
                ...
                if (TenantConstants.ASSETIC_WO_STATUS_INPRG.equals(wo.getStatus()) ||
                        TenantConstants.ASSETIC_WO_STATUS_TCOMP.equals(wo.getStatus()) ||
                        TenantConstants.ASSETIC_WO_STATUS_COMP.equals(wo.getStatus()) ||
                        TenantConstants.ASSETIC_WO_STATUS_ASSES.equals(wo.getStatus())) {
                    inprgWO(wo);
                }
                ...
                if (TenantConstants.ASSETIC_WO_STATUS_TCOMP.equals(wo.getStatus()) ||
                        TenantConstants.ASSETIC_WO_STATUS_COMP.equals(wo.getStatus()) ||
                        TenantConstants.ASSETIC_WO_STATUS_ASSES.equals(wo.getStatus())) {
                    tcompWO(wo);
                }
