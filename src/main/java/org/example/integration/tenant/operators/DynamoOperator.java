...
public class DynamoOperator {
    ...
    public static void putItemIntoDynamo(DynamoData data, String trackId) {
        AwsBasicCredentials awsCreds = AwsBasicCredentials.create(TenantConstants.AWS_ACCESS_KEY_INTEGRATION,
        ...
        try {
            ...
            if (Objects.isNull(filterExpression)) {
                QueryRequest queryRequest = QueryRequest.builder()
                        .tableName(tableName)
                        .keyConditionExpression(TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY1 + " = :" +
                                TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY1 +" AND "+
                                TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY2+" = :"+
                                TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY2)
                ...
                QueryRequest queryRequest = QueryRequest.builder()
                        .tableName(tableName)
                        .keyConditionExpression(TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY1 + " = :" +
                                TenantConstants.AWS_DYNAMO_INTEGRATION_RECORD_TABLE_PARTITION_KEY1)
                        .filterExpression(filterExpression)
                        .expressionAttributeValues(expressionAttributeValues)
                        .build();
                return dynamoDbClient.query(queryRequest);
