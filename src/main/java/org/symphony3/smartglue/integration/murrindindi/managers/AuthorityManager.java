...
public class AuthorityManager {
    ...
    public static String generateToken(String trackId) {
        ...
        String urlString = MurrindindiConstants.AUTHORITY_TOKEN_API;
        String urlParameters = "grant_type=password" +
                "&username="+MurrindindiConstants.AUTHORITY_USER +
                "&password="+MurrindindiConstants.AUTHORITY_PASSWORD +
                "&client_id="+MurrindindiConstants.AUTHORITY_CLIENT_ID +
                "&client_secret="+ MurrindindiConstants.AUTHORITY_CLIENT_SECRET+
                "&scope=openid authority_client";
        Map<String, String> authorityTokenHeaders = new HashMap<>();
        authorityTokenHeaders.put(MurrindindiConstants.HEADER_CONTENT_TYPE, MurrindindiConstants.CONTENT_TYPE_APPLICATION_X_WWW_FORM_URLENCODED);
        ...
        try {
            if (dynamicsTokenResponse.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                        ...
                        1, String.valueOf(dynamicsTokenResponse.getStatusCode()), dynamicsTokenResponse.getBody(),Integer.parseInt(MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI));
            ...
            IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                    " ", " ", MurrindindiConstants.COMPLETED_EVENT_FAILED,
                    1, MurrindindiConstants.STATUS_CODE_500, e.toString(),Integer.parseInt(MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI));
    ...
    public static AuthorityTaskResponse getAuthorityTask(String trackId, String authorityToken,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String query = "createdDateTime ge "+lastRunTime;

        String encodedQuery = URLEncoder.encode(query, StandardCharsets.UTF_8);
        String urlString = MurrindindiConstants.AUTHORITY_GET_TASK_API+MurrindindiConstants.AUTHORITY_REQUEST_FILTER_KEY+
        ...
        try {
            ...
            if (authorityTaskListResponse.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
    ...
    public static AuthorityCrmResponse.ResultItem getCrmByFormattedAccount(String trackId, String formattedAccount,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_CRM_API;
        String query = MurrindindiConstants.AUTHORITY_REQUEST_FORMATTED_ACC_FILTER_KEY+formattedAccount+"'";
        String encodedQuery = URLEncoder.encode(query, StandardCharsets.UTF_8);
        String urlString = baseUrlString+MurrindindiConstants.AUTHORITY_REQUEST_FILTER_KEY+
                encodedQuery;
        ...
        try {
            ...
            if (response.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                        formattedAccount, " ", MurrindindiConstants.COMPLETED_EVENT_FAILED,
    ...
    public static int getNameLink(String formattedAccount, String trackId, String authorityToken, String direction) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_NAME_LINK_API;
        String query = MurrindindiConstants.AUTHORITY_REQUEST_FORMATTED_ACC_FILTER_KEY+formattedAccount+"'";
        String encodedQuery = URLEncoder.encode(query, StandardCharsets.UTF_8);
        String urlString = baseUrlString+MurrindindiConstants.AUTHORITY_REQUEST_FILTER_KEY+ encodedQuery;
    ...
    public static AuthorityNameResponse.Result getNameData(int nameID, String trackId, String authorityToken,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_NAME_DATA_API;
    ...
    public static int getPropertyLink(String formattedAccount, String trackId, String authorityToken) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_PROPERTY_LINK_API;
        String query = MurrindindiConstants.AUTHORITY_REQUEST_FORMATTED_ACC_FILTER_KEY+formattedAccount+"'";
        String encodedQuery = URLEncoder.encode(query, StandardCharsets.UTF_8);
        String urlString = baseUrlString+MurrindindiConstants.AUTHORITY_REQUEST_FILTER_KEY+ encodedQuery;
    ...
    public static AuthorityPropertyResponse.ParcelAddressResult getPropertyData(int parcelID, String trackId,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_PROPERTY_API;
    ...
    public static String getDescription(AuthorityCrmResponse.ResultItem crm, String trackId,
        ...
        try {
            ...
            if (response.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                        crm.getFormattedAccount(), " ", MurrindindiConstants.COMPLETED_EVENT_FAILED,
                        1, String.valueOf(response.getStatusCode()), response.getBody(),Integer.parseInt(direction));
    ...
    public static HttpRsponseData updateTaskNotes(String trackId, String taskId, String authorityToken,
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_TASK_API;
        ...
        try {
            ...
            if (res.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
    ...
    public static List<AuthorityTaskResponse.Result> getCrmTaskByFormattedAccount(String trackId, String authorityToken,
        ...
        try {
            ...
            if (response.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                log.error("{} Error in fetching authority task list",trackId);
                IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                        sourceId, formattedAccount, MurrindindiConstants.COMPLETED_EVENT_FAILED,
                        1, String.valueOf(response.getStatusCode()), response.getBody(),Integer.parseInt(direction));
    ...
    public static HttpRsponseData openTask(String trackId, String payload, String authorityToken, String direction, AuthorityTaskManagingData taskData) {
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        headers.put(MurrindindiConstants.HEADER_CONTENT_TYPE, MurrindindiConstants.CONTENT_TYPE_APPLICATION_JSON);
        String urlString = MurrindindiConstants.AUTHORITY_TASK_OPEN_API;
        ...
        try {
            ...
            if (res.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                        taskData.getFriendlyIdStr(), taskData.getFormattedAccount(), MurrindindiConstants.COMPLETED_EVENT_FAILED,
                        1, String.valueOf(res.getStatusCode()), res.getBody(), Integer.parseInt(direction));
    ...
    public static List<AuthorityAttachmentMetadataResponse.AttachmentMetadata> getAttachmentsByFormattedAccount(String trackId,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        headers.put(MurrindindiConstants.HEADER_CONTENT_TYPE, MurrindindiConstants.CONTENT_TYPE_APPLICATION_JSON);
        String baseUrlString = MurrindindiConstants.AUTHORITY_ATTACHMENTS_METADATA_API;
    ...
    public static HttpRsponseData getAttachmentsByDownloadId(String trackId,String authorityToken, String downloadId, String direction, String sourceId, String targetId) {
        ...
        List<AuthorityAttachmentMetadataResponse.AttachmentMetadata> attachments = null;
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        String baseUrlString = MurrindindiConstants.AUTHORITY_ATTACHMENTS_DOWNLOAD_API+"/"+downloadId;
    ...
    public static AuthorityGPSLocationResponse.Coordinate getGPSLocationByCrm(String trackId, String authorityToken,
        ...
        headers.put(MurrindindiConstants.HEADER_AUTHORIZATION, MurrindindiConstants.HEADER_AUTHORIZATION_BEARER+authorityToken);
        headers.put(MurrindindiConstants.HEADER_CONTENT_TYPE, MurrindindiConstants.CONTENT_TYPE_APPLICATION_JSON);
        String baseUrlString = MurrindindiConstants.AUTHORITY_GET_CRM_API+"/"+crmId+"/gpsLocations";
        ...
        try {
            ...
            if (response.getStatusCode() == Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
                ...
                if (responseObj.getResult() != null && !responseObj.getResult().isEmpty() &&
                    ...
                    IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                            sourceId, " ", MurrindindiConstants.COMPLETED_EVENT_FAILED,
                            1, MurrindindiConstants.STATUS_CODE_500, "Empty GPS location / property Link from Authority",Integer.parseInt(direction));
