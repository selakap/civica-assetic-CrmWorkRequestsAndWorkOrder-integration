...
public class AuthorityAttachmentsProcessor implements Runnable {
    ...
    public void run() {
        try {
            ...
            IntegrationCompletedEventData items = new IntegrationCompletedEventData(Integer.parseInt(MurrindindiConstants.COMPLETED_EVENT_RECORD_TYPE_RECORD),
                    formattedAccount+"-Attachments", " ", MurrindindiConstants.COMPLETED_EVENT_FAILED,
    ...
    public List<AuthorityAttachmentMetadataResponse.AttachmentMetadata> getAttachmentsMetadata() throws Exception {
        ...
        if (payload != null) {
            ...
            return AuthorityManager.
                    getAttachmentsByFormattedAccount(trackId, authorityToken, payload,MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI,formattedAccount,wrId);
        } else {
    ...
    public boolean isProcessableAttachment(AuthorityAttachmentMetadataResponse.AttachmentMetadata data) throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        HttpRsponseData response = AsseticManager.getDocumentById(trackId, data.getId(),MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI,formattedAccount,wrId);
    ...
    public void processingAttachment(String downloadId, String externalId, String name) throws Exception {
        HttpRsponseData res = AuthorityManager.getAttachmentsByDownloadId(trackId, authorityToken, downloadId, MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI,formattedAccount,wrId);
        if (res == null || res.getStatusCode() != Integer.parseInt(MurrindindiConstants.STATUS_CODE_200)) {
        ...
        if (base64EncodedAttachment != null) {
            ...
            if (AsseticManager.uploadDocuments(trackId, payload,MurrindindiConstants.TENANT_INTEGRATION_ID_MURRINDINDI,formattedAccount,wrId)) {
