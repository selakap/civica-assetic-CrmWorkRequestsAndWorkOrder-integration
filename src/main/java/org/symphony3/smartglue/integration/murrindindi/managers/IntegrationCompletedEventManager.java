...
import org.symphony3.smartglue.integration.murrindindi.models.IntegrationCompletedEvent;
...
public class IntegrationCompletedEventManager implements Runnable{
    ...
    public void run() {
        ...
        detail.setTenantId(Integer.parseInt(MurrindindiConstants.TENANT_ID_MURRINDINDI));
        ...
        headers.put(MurrindindiConstants.COMPLETED_EVENT_API_KEY_HEADER, MurrindindiConstants.COMPLETED_EVENT_API_KEY_VALUE);
        HttpRsponseData eventResponse = HttpOperator.commonHttpCall(MurrindindiConstants.COMPLETED_EVENT_URL,eventPayload,headers,MurrindindiConstants.METHOD_POST,trackId);
